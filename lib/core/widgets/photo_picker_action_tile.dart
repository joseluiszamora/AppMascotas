...
class PhotoPickerActionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final foregroundColor = highlighted ? accentColor : AppColors.textHint;
      ...
      child: InkWell(
        ...
        child: Ink(
          ...
          decoration: BoxDecoration(
            color: enabled ? backgroundColor : AppColors.border.withAlpha(40),
            borderRadius: BorderRadius.circular(16),
            border: Border.all(
          ...
          child: Column(
            ...
            children: [
              Icon(
                ...
                color: enabled ? foregroundColor : AppColors.textHint,
                size: 28,
              ),
